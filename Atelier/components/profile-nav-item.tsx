...
export function ProfileNavItem() {
  ...
  return (
    <div className="sidebar-profile">
      <Link href="/profile" className="profile-nav-link" aria-label="Your profile" title={profile.displayName || "Your profile"} aria-current={pathname.startsWith("/profile") ? "page" : undefined} data-active={pathname.startsWith("/profile")}>
